...
class MemberRoleUpdate(commands.Cog):
    ...
    fu_onboard_payload = disnake.Embed(
        title="Welcome to PlanetSide 2 with Freelancers Union!",
        color=13729282,
        description="This message is a quick-start guide to help you get the most out of playing PlanetSide with FU.\nAny questions ping \n`@PS2 Division Officer`\n\n** **"
        )
    fu_onboard_payload.add_field(
        name="Channels :newspaper:",
        value="> [#ps2-general](https://discord.com/channels/282514718445273089/290929845788213249) : Main chatroom to talk with your fellow soldiers.\n> [#ps2-announcements](https://discord.com/channels/282514718445273089/567172184913739787) : Noticeboard for events.\n> [#ps2-roles](https://discord.com/channels/282514718445273089/983434676477775922) : Role menu for PS2.\n> [#ps2-loadouts](https://discord.com/channels/282514718445273089/803987308935643167) : Share and discuss class loadouts.\n\n** **",
        inline=False
    )
...
#current best effort for message.
"""
{
  "content": null,
  "embeds": [
    {
      "title": "Welcome to The Freelancers Union!",
      "color": 16711680,
      "fields": [
        {
          "name": "Divisions (Our main games)",
          "value": "- PlanetSide 2\n- Arma 3"
        },
        {
          "name": "MAIN ACTIVITY",
          "value": "Always check the [#schedule](https://discord.com/channels/282514718445273089/539192935258783744) for upcoming events.\n- FU Prime Time - everyday <t:1669921200:t> - <t:1667340000:t> (This is YOUR timezone!)\n- PlanetSide - Wednesdays\n- Arma 3 - Fridays"
        },
        {
          "name": "DISCORD",
          "value": "- This is FU's Townhall. We use it for text, organisation and event notifications.\n- Grab roles for the games you want to play in the #role-menu.\n- Chat with your fellow players in #general or the divisional channels:\n> [#ps2-general](https://discord.com/channels/282514718445273089/290929845788213249)\n> [#a3-general](https://discord.com/channels/282514718445273089/531220605391994892)"
        },
        {
          "name": "TEAMSPEAK",
          "value": "- Our main voice platform and the best place to get to know others in the community.\n- Free to download: [Download TeamSpeak3](https://www.teamspeak.com/en/downloads/)\n- No mic required, feel free to lurk and listen.\n```\nserver: ts.fugaming.org\npasswd: futs\n```"
        },
        {
          "name": "MEMBERSHIP",
          "value": "- Complete the [Intro Module](https://docs.google.com/document/d/1TRdV8-9JxXg9gLIp_PC56T5GyTiPxT1uxVLM1_9xRu4/edit?usp=sharing) to gain FU membership.\n- Membership gives you the Soldier rank in PlanetSide and exclusive access to the Discord member's area.\n- It is optional. You should only accept membership if you wish to associate with FU and support what we do."
        },
        {
          "name": "LEADERSHIP",
          "value": "- **Officers**: host events, mentor players, create content and develop the community.\n- Think you've got something to give? Contact any officer to learn more - you'll be supported and mentored from day 1."
        }
      ],
      "thumbnail": {
        "url": "https://avatars.githubusercontent.com/u/106548890?s=200&v=4"
      }
    }
  ],
  "attachments": []
