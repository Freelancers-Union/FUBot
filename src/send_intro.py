...
class SendIntro(commands.Cog):
    ...
    async def paginator(self):
        ...
        embeds = [
            ...
            ).set_thumbnail(url=f"{s3_assets}schedule.png"),
            disnake.Embed(
                title="Divisions",
            ...
            ).set_thumbnail(url=f"{s3_assets}leadership.png"),
            disnake.Embed(
            ...
            ).set_thumbnail(url=f"{s3_assets}ethos.png"),
            # Commented out to disable the screen for newcomers.
            #   disnake.Embed(
            #       title="Membership",
            ...
            #       colour=disnake.Colour(14812691),
            #   ).set_thumbnail(
            #     url=f"{s3_assets}membership.png"
            #   ),
        ]
        return embeds
    ...
    async def on_member_join(self, member):
        ...
        await member.send(
            content=None, embed=embeds[0], view=Menu(embeds=embeds, member=member)
        )
    ...
    async def intro(self, inter):
        ...
        await inter.author.send(
            content=None, embed=embeds[0], view=Menu(embeds=embeds, member=inter.author)
        )
